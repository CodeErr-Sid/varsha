...
// Toggle filter categories on window resize
$(window).resize(function () {
  if ($(window).width() <= 1276) {
    $('#categories, #filters').hide();
  } else {
    $('#categories, #filters').show();
  }
});
  ...
  var filterList = {
    init: function () {
      ...
      $("#portfoliolist").mixItUp({
        ...
        load: {
          filter: ".asp-fruits, .asp-vegetables, .frz-fruits, .frz-vegetables"
        }
      });
    }
  };
...
// Initially, show Aspetic filters

// Click event for the Aspeptic button
$('#aspeptic').click(function () {
  // Add active class to the clicked button
  $(this).addClass('active');
  $('#frozen, #allaspfrz').removeClass('active'); // Remove active class from other buttons
  // Hide Frozen and All Asp/Frz products
  $('.frz, .all_asp_frz').hide();
  $('.asp .aspeptic').click().addClass('active');
  // Show Aspetic products
  $('.asp').show();
});

// Click event for the Frozen button
$('#frozen').click(function () {
  // Add active class to the clicked button
  $(this).addClass('active');
  $('#aspeptic, #allaspfrz').removeClass('active'); // Remove active class from other buttons
  // Hide Aspeptic and All Asp/Frz products
  $('.asp, .all_asp_frz').hide();
  $('.frz .frozen').click().addClass('active');
  // Show Frozen products
  $('.frz').show();
});

// Click event for the All Asp/Frz button
$('#allaspfrz').click(function () {
  // Add active class to the clicked button
  $(this).addClass('active');
  $('#aspeptic, #frozen').removeClass('active'); // Remove active class from other buttons
  // Show both Aspeptic and Frozen products
  $('.asp, .frz').hide();
  $('.all_asp_frz .all-asp-frz').click().hide();
  $('.all_asp_frz').show();
});
